...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse flex-grow-0 fs-5" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" target="_blank" href="https://www.climatiq.io/docs#travel-flights">API Climatiq.io</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <!-- light mode switch -->
    <div class="hstack gap-5 form-check form-switch pe-4 pt-2  position-fixed top-75 end-0">
    ...
    <main>
        ...
        <div class="container p-sm-5 p-2">
            ...
            <div class="mx-auto" data-bs-spy="scroll" data-bs-target="# -sections" data-bs-offset="0" tabindex="0">
                ...
                <!--                      -->
                <section class="row my-5" data-aos="fade-up">
                ...
                <!-- Emission - Fuel_Type -->
                <!--                      -->
                <section class="row my-5" data-aos="fade-up" id="graphic-1">
                ...
                <!--                        -->
                <section class="row my-5 justify-content-center" data-aos="fade-up">
                            ...
                            <div class="col-12 col-lg-6 col-xl-12 d-flex justify-content-center mb-5">
                                <div class="card w-100 text-dark bg-light" id="cocard">
                                    ...
                                    <div class="card-footer">
                                        <p class="card-text text-center fw-semibold fs-5"><span id="consumption_calculated">-</span> kg</p>
                                    </div>
                                </div>
                            </div>
                        </div>
